                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 space-x-1'>
                    ...
                    <div className='col-span-6 flex flex-col justify-evenly'>
                        ...
                        <h3 className='text-charcoal text-lg font-normal text-center lg:text-start opacity-75 pt-5 lg:pt-0'>Build skills with our courses and mentor from world-class companies.</h3> */}
                                                <h1 className='text-midnightblue text-4xl sm:text-5xl font-semibold text-center lg:text-start lh-120 pt-5 lg:pt-0'>Advance your learning skills with us.</h1>
                                                <h3 className='text-charcoal text-lg font-normal text-center lg:text-start opacity-75 pt-5 lg:pt-0'>Build skills with our courses and mentors.</h3>
                    ...
                    <div className='col-span-6 flex justify-center'>
                        <Image src="/assets/banner/table.png" alt="nothing" width={1000} height={805} />
                    </div>
                </div>
            </div>
        </div>
